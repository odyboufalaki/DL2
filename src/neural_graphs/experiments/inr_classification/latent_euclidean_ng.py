...
def latents(cfg, hydra_cfg):
    ...
    zs, _ = collect_latents(model, loader, device)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(cfg.latent_analysis.outdir, "euclidean_distance_matrix_ng.png"), dpi=300)
    plt.close()
    print("Euclidean distance matrix saved to:", os.path.join(cfg.latent_analysis.outdir, "euclidean_distance_matrix_ng.png"))
