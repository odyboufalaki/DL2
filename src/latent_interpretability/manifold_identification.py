...
def get_args():
    ...
    p.add_argument("--outdir", type=str, default="figs/manifold")
...
# --------------------------------------------------
# NOTA EDU:Pongo esto temporalmente, pero supongo que tendrás cosas más interesantes para hacer aquí
...
def main():
    ...
    scatter(
        emb_tsne, ys, f"t-SNE - {args.split}", os.path.join(args.outdir, "tsne.png")
    )
